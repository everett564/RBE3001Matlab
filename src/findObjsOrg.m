function [imDetectedDisk, robotFramePose, diskDia] = findObjsOrg(imOrig, T_checker_to_robot, T_cam_to_checker, cameraParams)
...
[mask,im] = createMask2(im);
%[mask,im] = createMask(im);
